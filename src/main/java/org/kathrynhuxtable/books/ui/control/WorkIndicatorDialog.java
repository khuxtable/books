/*
 * Public domain. Use as you like. No warranties. (cc) @imifos
 */
...
public class WorkIndicatorDialog<P, R> {
	 ...
	 *
	 */
	public void exec(P parameter, Function<P, R> func) {
		setupDialog();
	...
	private void setupAnimationThread() {
		...
		animationWorker = new Task<Object>() {
			...
			protected Object call() throws Exception {
				/*
				 * This is activated when we have a "progressing" indicator. This thread is used to advance progress every XXX
				 * milliseconds. In case of an INDETERMINATE_PROGRESS indicator, it's not of use. for (int i=1;i<=100;i++) {
